...
// All paths now require authentication
...
export default function Layout({ children }) {
  ...
  React.useEffect(() => {
    const checkUser = async () => {
      try {
        ...
        // User not authenticated - trigger login automatically
        setLoading(false);
        setUser(null);
  ...
  if (!user) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-950 via-blue-950 to-indigo-950">
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-gray-950 via-gray-900 to-blue-950">
        <Sidebar className="border-r border-gray-800 bg-gray-900/95 backdrop-blur-sm">
          <SidebarHeader className="border-b border-gray-800 p-6">
            <Link to={createPageUrl("Dashboard")} className="flex items-center gap-3">
              ...
              />
              <span className="text-xl font-bold text-gray-100 tracking-tighter">RecruitBridge</span>
            </Link>
          </SidebarHeader>
                ...
                <SidebarMenu className="space-y-1">
                  {navigationItems.map((item) => (
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton
                        asChild
                        className={`hover:bg-blue-900/30 hover:text-blue-300 transition-all duration-200 rounded-xl ${
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="w-full p-0 h-auto">
                    <div className="flex items-center gap-3 w-full p-2 rounded-lg hover:bg-gray-800 transition-colors">
                      ...
                      <div className="flex-1 min-w-0 text-left">
                        <p className="text-sm truncate text-gray-100 font-semibold">
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-gray-900/95 backdrop-blur-sm border-b border-gray-800 px-6 py-4 md:hidden">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <Link to={createPageUrl("Dashboard")} className="flex items-center gap-2">
                  ...
                  />
                  <span className="font-semibold text-gray-100">RecruitBridge</span>
                </Link>
              </div>
            </div>
          </header>
